...
SSCRIPTS = [
    ...
    "grid3d_average_map = subscript.grid3d_average_map.grid3d_average_map:main",
    "grid3d_contact_map = subscript.grid3d_contact_map.grid3d_contact_map:main",
    "grid3d_hc_thickness = subscript.grid3d_average_map.grid3d_hc_thickness:main",
