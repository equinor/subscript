...
.. code-block:: yaml
  ...
  field_stat:
    ...
    # under rms/output/aps/ERTBOX.EGRID in ERT <CONFIG_PATH>
...
def check_if_iterations_exist(ens_path, input_dict):
    ...
    for iter_number in iter_list:
        ...
        if not full_path_for_iter.exists():
            return False
    return True
                    ...
                    for prop_name in cont_prop_dict[zone]:
                        for iteration in iter_list:
                            ...
                            if iteration == iter_list[0]:
                                ...
                                prop_param_diff = \
                                    prop_param_upd.copy(new_difference_name)
