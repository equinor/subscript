...
class Fluxnum:
    ...
    def __init__(self, grid: Grid) -> None:
        ...
        self.grid = grid
        self.fluxnum_kw = ResdataKW("FLUXNUM", grid.get_global_size(), int_type)
        self.included_wells: list[str] = []
        self.lgr_region: ResdataRegion | None = None
        self.inner_region: ResdataRegion | None = None

    def copy_actnum(self, actnum: ResdataKW) -> None:
        """
    ...
    def set_inner_region(self, *args: Any, **kwargs: Any) -> None:  # noqa: ANN401
        """
    ...
    def set_lgr_box_region(self, i: str, j: str, k: str) -> None:
        """
    ...
    def set_fluxnum_kw_from_file(self, fluxnum_file: str) -> None:
        """
    ...
    def get_fluxnum_kw(self) -> ResdataKW:
        return self.fluxnum_kw

    def include_nnc(self, egrid_file: ResdataFile) -> None:
        """
    ...
    def include_well_completions(
        self,
        completion_list: list[list[tuple[int, int, int]]],
        well_list: list[str],
    ...
    def write_fluxnum_kw(self, filename_path: str) -> None:
        """
...
class FluxnumFipnum(Fluxnum):
    ...
    def set_inner_region(
        self, i: str, j: str, k: str, fipnum_region: str, fipnum_file: str | None
    ) -> None:
        fipnum: ResdataKW
        if fipnum_file:
        ...
        self.inner_region = flux_util.filter_region(
            self.grid, i, j, k, fipnum_region, fipnum
        )
