                    ...
                    if not len(line.strip()) == 0:
                        ...
                        if "--" not in line_strip[0:3] and not len(line_strip) == 0:
                            ...
                            if " /" not in line_strip:
                                print("ERROR: COMPDAT line not completed with /! ...")
                                sys.exit(1)
                            ...
                            if wellname_strip not in well_list:
                                ...
                                for k in range(
                                    ...
                                    if comp_ijk not in completions[-1]:
                                ...
                                for k in range(
                                    ...
                                    if comp_ijk not in completions[ind]:
...
def replace_completions_lgr(
    ...
    for FILENAME in schedule_file_list:
        ...
        for line in f:
            ...
            if "COMPDAT" in line_strip[0:7] or in_COMPDAT:
                # COMPDAT keyword found!
                in_COMPDAT = False
                is_lgr = False
                has_COMPDATL = False
            ...
            elif "WELSPECS" in line_strip[0:8] or in_WELSPECS:
                # WELSPECS keyword found!
                in_WELSPECS = False
                has_WELSPECL = False
                is_lgr = False
            ...
            elif "COMPLUMP" in line_strip[0:8] or in_COMPLUMP:
            ...
            elif "WPIMULT" in line_strip[0:7] or in_WPIMULT:
