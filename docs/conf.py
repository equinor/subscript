...
htmlhelp_basename = "subscriptdoc"
...
latex_documents = [
    (master_doc, "subscript.tex", "subscript Documentation", "Equinor", "manual")
]
...
man_pages = [(master_doc, "subscript", "subscript Documentation", [author], 1)]
