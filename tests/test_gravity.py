...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"input":{
             ...
             "seabed_map": "./tests/testdata_gravity/seabed.gri"
             }
          }, "Input should be a valid date"),
        ({"input":{
             "diffdates":[["2020-07-01", "2018-01-01"]],
             "seabed_map": "./tests/testdata_gravity/no_seabed.gri"
             }
...
def test_main(res_data, mocker):
    ...
    mocker.patch("sys.argv", [__file__, test_resfile, "--configfile", str(test_cfg), "--outputdir", "./"])
    grav_subs_maps.main()
