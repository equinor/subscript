...
DROGON_FIPNUM.PRT       - Eclipse version 2022.2, FIP=2 (FIPNUM only, 4 reports, RESERVOIR VOLUME report only at  
                        initial date)
DROGON_FIPZON.PRT       - Eclipse version 2022.2, FIP=3 (all FIP-vectors) (initial BALANCE and RESERVOIR VOLUME only)
...
DROGON_NOBAL_FLOW.PRT   - Flow version 2025.10-pre, No BALANCE reports
